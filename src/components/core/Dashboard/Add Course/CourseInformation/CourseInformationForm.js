...
const CourseInformationForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    // Check your database enum values and use the exact string that's in your schema
    // The error shows "Draft" is not valid, so we need to use the actual value from the schema
    formData.append("status", COURSE_STATUS.DRAFT.toLowerCase()) // Convert to lowercase if that's what your schema expects
